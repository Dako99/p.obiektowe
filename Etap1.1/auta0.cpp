#include <fstream> //obłsuga pliku .txt
#include "auta0.h"
...
bool Auto::wczytaj() {		//wczytuje dane z pliku
	...
	cout << "Wczytano prawidłowowo" << endl;
...
//QuickSort
			...
			cout << endl << "Tablica a posortowana rosnąco:" << endl;
			for (int i = 0; i < 8; i++) cout << b[i] << endl;

			sort(b, b + 8, greater < int >());

			cout << endl << "Tablica a posortowana malejąco:" << endl;
			for (int i = 0; i < 8; i++) cout << b[i] << endl;
